...
import dev.musagy.chatGroup.model.chat.UserSummary;
...
public interface ChatRepository extends JpaRepository<Chat, Long> {
    @Query("""
        SELECT new dev.musagy.chatGroup.model.chat.UserSummary(
            cu.user.id,
            cu.user.username,
            cu.user.userAlias,
            cu.role
    ...
    """)
    Page<UserSummary> findUserSummariesPageByChatId(@Param("chatId") Long chatId, Pageable pageable);
